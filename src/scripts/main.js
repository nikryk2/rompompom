...
const tongueTwisters = [
    {
        ...
        tips: [
            ...
            "Техника: При произношении 'Р' приподнимите кончик языка к верхнему нёбу, не касаясь его, и создайте вибрацию потоком воздуха"
        ]
    },
    {
        title: "Средняя на Р",
        ...
        tips: [
            ...
            "Техника: Язык должен быть напряжен и немного загнут назад, кончик направлен к альвеолам (бугоркам за верхними зубами)"
        ]
    },
    {
        ...
        tips: [
            ...
            "Техника: Для чёткого 'Р' и 'Л' чередуйте положение языка: для 'Р' - кончик у верхнего нёба с вибрацией, для 'Л' - кончик прижат к верхним зубам"
        ]
    },
    {
        title: "Про тигра",
        ...
        tips: [
            ...
            "Техника: Представьте, что рычите как тигр - широко откройте рот, язык поднят в передней части, кончик свободно вибрирует от потока воздуха"
        ]
    },
    {
        title: "Сложная на Р",
        ...
        tips: [
            ...
            "Техника: При произношении слов с двумя 'Р' (как в слове 'Арарат') важно сохранять положение языка между звуками - приподнятым к верхнему нёбу"
        ]
    },
    {
        title: "Про ворону",
        ...
        tips: [
            ...
            "Техника: Держите язык в средней позиции рта, слегка приподнятым, кончик должен быть расслаблен для легкой вибрации при произношении 'Р'"
        ]
    }
];
